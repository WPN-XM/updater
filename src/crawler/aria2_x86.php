 ...
 */
class aria2_x86 extends VersionCrawler
{
    ...
    public function crawlVersion()
    {
        return $this->filter('a')->each(function ($node) {
                 ...
                 *
                 * https://github.com/tatsuhiro-t/aria2/releases/download/release-1.19.3/aria2-1.19.3-win-32bit-build1.zip
                 *
                ...
                if (preg_match("#/tatsuhiro-t/aria2/releases/download/release-(\d+\.\d+.\d+)/aria2-#", $node->attr('href'), $matches)) {
                    ...
                    if (version_compare($version, $this->registry['aria2-x86']['latest']['version'], '>=') === true) {
                        return array(
                            'version' => $version,
                            'url'     => $download_file,
                        );
