...
class phpext_pdo_sqlsrv extends VersionCrawler
{
    ...
    private $url_template = 'https://github.com/Azure/msphpsql/releases/download/v%version%/php_pdo_sqlrv_%version%_%bitsize%.zip';

    public function crawlVersion()
    {
        return $this->filter('a')->each(function ($node) {

            // https://github.com/Azure/msphpsql/releases/download/v4.0.4/php_pdo_sqlsrv_4.0.4_x64.zip
