<?php
	 ...
	 * ------------------------
	 * Last Update Mon, 06 Aug 2012 16:11:01 +0000.
 ...
 return array (
  ...
  array (
    ...
    array (
      'version' => '1.3.4',
      'url' => 'http://www.nginx.org/download/nginx-1.3.4.zip',
    ),
  ),
  'php' =>
  array (
  ...
  array (
    ...
    array (
      'version' => '5.5.24',
      'url' => 'http://mirror2.hs-esslingen.de/mariadb/mariadb-5.5.25/windows/mariadb-5.5.24-win32.zip',
    ),
  ),
  'xdebug' =>
  array (
  ...
  array (
    'current' => '3.1.10',
    '3.1.10' => 'http://downloads.php.net/pierre/php_apc-3.1.10-5.4-vc9-x86.zip',
    '3.1.12' => 'http://dev.freshsite.pl/nc/php-accelerators/apc/download/apc-3112-beta-for-php-54-vc9-win72008.html',
    'latest' =>
    array (
      'version' => '3.1.12',
      'url' => 'http://dev.freshsite.pl/nc/php-accelerators/apc/download/apc-3112-beta-for-php-54-vc9-win72008.html',
    ),
  ),
  'phpmyadmin' =>
  array (
    'current' => '3.4.9',
    '3.5.2.1' => 'http://kent.dl.sourceforge.net/project/phpmyadmin/phpMyAdmin/3.5.2.1/phpMyAdmin-3.5.2.1-english.zip',
    'latest' =>
    array (
      'version' => '3.5.2.1',
      'url' => 'http://kent.dl.sourceforge.net/project/phpmyadmin/phpMyAdmin/3.5.2.1/phpMyAdmin-3.5.2.1-english.zip',
    ),
  ),
  'adminer' =>
  array (
    ...
    array (
      'version' => '3.5.0',
      'url' => 'http://garr.dl.sourceforge.net/project/adminer/Adminer/Adminer%203.5.0/adminer-3.5.0.php',
    ),
  ),
  'phpext_xdebug' =>
  array (
